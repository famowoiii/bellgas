...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $stats = [
            ...
            'products_sold' => DB::table('order_items')
                ...
                ->whereIn('orders.status', ['DONE', 'PAID', 'PROCESSED', 'ON_DELIVERY', 'PICKED_UP'])
                ->sum('order_items.quantity'),
            'total_revenue' => Order::whereIn('status', ['DONE', 'PAID', 'PROCESSED', 'ON_DELIVERY', 'PICKED_UP'])->sum('total_aud'),
            'today_revenue' => Order::whereIn('status', ['DONE', 'PAID', 'PROCESSED', 'ON_DELIVERY', 'PICKED_UP'])
                ->whereDate('created_at', today())->sum('total_aud'),
            'this_month_revenue' => Order::whereIn('status', ['DONE', 'PAID', 'PROCESSED', 'ON_DELIVERY', 'PICKED_UP'])
    ...
    public function salesChart(Request $request)
    {
        ...
        $salesData = Order::whereIn('status', ['DONE', 'PAID', 'PROCESSED', 'ON_DELIVERY', 'PICKED_UP'])
