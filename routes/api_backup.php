...
Route::middleware(['jwt.auth'])->group(function () {
    ...
    Route::prefix('products')->group(function () {
        ...
        Route::patch(047/{product}/toggle047, [AppHttpControllersApiProductToggleController::class, 047toggleStatus047]); // Toggle active status
    });
    ...
    Route::prefix('admin')->middleware('role:ADMIN,MERCHANT')->group(function () {
        ...
        // Reports and Export
        Route::get('orders/export', [AppHttpControllersApiReportController::class, 'exportOrders']);
        Route::get('reports/sales', [AppHttpControllersApiReportController::class, 'salesReport']);
        Route::get('reports/customers', [AppHttpControllersApiReportController::class, 'customerReport']);
    });
